...
name: unslop
description: >-
  Use when writing or editing any prose a human will read: docs, READMEs,
  commit messages, PR bodies, issue text, comments, plans, or chat replies.
  Strips AI tells (significance inflation, em dashes, "not just X, it's Y",
  filler, passive voice) and adds voice. Also use when the user says
  "unslop", "this reads like AI", "make it sound human", or "cut the slop".
---

# Unslop

**Announce at start:** "I'm using the unslop skill to cut AI tells from this."
...
Adapted from [poteto/plugins](https://github.com/poteto/plugins/blob/main/pstack/skills/unslop/SKILL.md) (`pstack/skills/unslop`).
